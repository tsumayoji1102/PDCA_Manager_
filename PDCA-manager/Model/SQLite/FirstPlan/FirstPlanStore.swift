    ...
    **/
    ...
    static func addNewPlan(paramDic: Dictionary<String, String>) -> Bool{
        ...
        if (insertSuccess != true){
            getLog.getLog(message: "追加エラー")
            return false
        }else{
            getLog.getLog(message: "追加成功")
            return true
    ...
    static func deletePlan(deletePlan: FirstPlan, planList: Array<FirstPlan>) -> Array<FirstPlan>!{
        ...
        if(deleteSuccess != true){
            getLog.getLog(message: "削除エラー")
            return nil
            
        }else{
            getLog.getLog(message: "削除成功")
        }
    ...
    static func changeDeleteFlg() -> Bool{
        ...
        if(updateSuccess != true){
            getLog.getLog(message: "終了エラー")
            return false
            
        }else{
            getLog.getLog(message: "終了成功")
            return true
        }
    }
